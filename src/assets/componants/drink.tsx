...
const DailayDrink = () => {
  ...
  const [DailayDrink, setDailayDrink] = useState<number>(0);
  ...
  const onClick = () => {
    setDailayDrink(weight * 2.2 * (30 / 2));
    console.log(DailayDrink);
  };
  ...
  return (
    <>
      ...
      <h2>{DailayDrink.toFixed(2)} มิลลิลิตร</h2>
